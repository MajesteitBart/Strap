// Canonical attribution strings for Strap activity.
//
...
//   panel agent    -> "[member]'s Strap"            e.g. "Fergus's Strap"
//
...
export type AttributionActor = {
  ...
  // The agent/app name for agent actions ("Claude Code", "Codex", "Strap" for
