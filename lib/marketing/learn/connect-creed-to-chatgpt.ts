  ...
  body: [
    ...
    { type: "h2", text: "Step by step" },
    {
      ...
      items: [
        ...
        "A browser step opens the Strap consent screen; sign in to strap.md if needed.",
    ...
    {
      type: "p",
      text: "Strap MCP uses OAuth, so there is nothing to copy. When you authorize, you are taken to the Strap consent screen. Make sure you are signed in to strap.md, then click Allow. That grant is what lets ChatGPT read your profile; you do not create or paste any token.",
    },
  ...
  faq: [
    {
      ...
      answer:
        "Open ChatGPT Settings, go to Connectors, add a custom or remote MCP server using the URL https://strap.bvdm.ai/mcp, then authorize by clicking Allow on the Strap consent screen while signed in to strap.md.",
    },
    {
