...
export const whyChatgptForgetsYou: Article = {
  ...
  body: [
    ...
    {
      type: "p",
      text: "That is what Strap is: one personal context file that every AI reads before it answers. It is plain Markdown you own, organized into short sections, connected to your agents over MCP. Because the context lives in a file rather than inside one vendor's memory, it is portable by construction, and you can read, edit, export, or delete it whenever you want.",
    },
    {
      type: "table",
      caption:
  ...
  related: [
    ...
    {
      label: "Strap vs ChatGPT memory",
      href: "/learn/strap-vs-chatgpt-memory",
    },
  ],
};
