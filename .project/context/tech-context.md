...
- The root web-app TypeScript project excludes `packages/strap/`, `packages/creed-cli/`, and `packages/varlock-strap-plugin/`; each independent package owns its dependency install, build, tests, and type-check.
