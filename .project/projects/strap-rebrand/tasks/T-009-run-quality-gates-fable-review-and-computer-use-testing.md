...
- [ ] Computer-use covers required public and available authenticated routes with console/network evidence.
- [ ] Delano evidence is complete and the project is ready for operator-gated release.
