...
- Independent authorization review remains required before hosted cutover. Review viewer scopes, service contexts, membership revocation, secret boundaries and credential ceilings; resolve critical findings and rerun affected negative tests.
