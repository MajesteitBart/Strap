...
//
// Company-aware: when the active Strap is a Company Strap, the settings live on the
...
// Personal Straps keep the exact user-scoped behaviour.
...
export async function GET(request: Request) {
  ...
  // loads its own mode/key-status regardless of the active-Strap cookie.
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    // active-Strap cookie. This keeps read and write pointed at one company
