...
export function GettingStartedCardView({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-[var(--strap-border)] bg-[var(--strap-surface)] shadow-[0_10px_30px_rgba(28,28,26,0.10)]">
      {allDone ? (
        ...
        <div className="relative flex items-center gap-3 p-3.5 pr-14">
          ...
          <div className="flex-1 truncate text-[13px] font-medium leading-5 text-[var(--strap-text-primary)]">
            You&apos;re all set.
          </div>
          <button
            type="button"
        ...
        <>
          ...
          >
            ...
            <span className="flex-1 truncate text-[13px] font-medium leading-5 text-[var(--strap-text-primary)]">
              Get started
            </span>
      ...
      <span
        className={cn(
          "flex h-4 w-4 shrink-0 items-center justify-center rounded-full border transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
            ...
            ? "scale-100 border-transparent bg-[var(--strap-accent)]"
            : "border-[var(--strap-border-strong)] bg-transparent",
        )}
      >
        <Check
          strokeWidth={3}
