    ...
    <DropdownMenuSub open={subOpen} onOpenChange={setSubOpen}>
      <DropdownMenuSubTrigger
        ...
        className={cn(
          ...
          "group/feedback gap-1.5 rounded-[var(--radius-md)] px-2.5 py-2 text-sm focus:bg-[var(--strap-surface-raised)] data-[state=open]:bg-[var(--strap-surface-raised)]",
              ...
              <AnimatePresence mode="wait" initial={false}>
                {status === "sent" ? (
                  <motion.span
                    ...
                    className="text-[12px] font-medium text-[var(--strap-success,#059669)]"
                  >
                  ...
                  <motion.span
                    ...
                    exit={{ opacity: 0, y: -2 }}
                    transition={{ duration: 0.16, ease: [0.22, 1, 0.36, 1] }}
                    className="truncate text-[12px] font-medium text-[var(--strap-danger,#DC2626)]"
                  ...
                  <motion.span
                    ...
                    exit={{ opacity: 0, y: -2 }}
                    transition={{ duration: 0.16, ease: [0.22, 1, 0.36, 1] }}
                    className="text-[12px] text-[var(--strap-text-tertiary)]"
                  >
                    Need help?{" "}
                    <a
                      href={CONTACT_MAILTO}
              ...
              <button
                ...
                className={cn(
                  ...
                  canSubmit
                    ...
                    : "bg-[var(--strap-surface-raised)] text-[var(--strap-text-tertiary)]"
                )}
              >
