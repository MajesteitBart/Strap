...
// (strap-app) instances aren't mounted because the entitlement gate hasn't
...
import { showVersionUpdateToast } from "@/components/strap/app-version-notifier";
import { GettingStartedCardView } from "@/components/strap/getting-started-card";
import {
