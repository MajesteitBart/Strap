...
import { qualityScoreColor } from "@/components/strap/file-quality-ui";
  ...
  return (
    ...
    >
      ...
      {graph.nodes.length > 0 && graph.edges.length === 0 ? (
        <div className="pointer-events-none absolute inset-x-4 bottom-4 mx-auto max-w-md px-4 py-3 text-center text-[13px] leading-5 text-[var(--strap-text-secondary)]">
      ...
      {tooltip ? (
        <div
          className="pointer-events-none absolute z-10 w-64 rounded-lg border border-[var(--strap-border)] bg-[var(--strap-surface)] p-3 text-[12px] shadow-[0_8px_24px_rgba(28,28,26,0.10)]"
          style={{
        ...
        >
          <div className="flex items-baseline justify-between gap-3">
            ...
            {typeof tooltip.score === "number" ? (
              ...
              <div className="shrink-0 text-[12px] font-medium text-[var(--strap-text-tertiary)]">
                No score
              </div>
            )}
          </div>
