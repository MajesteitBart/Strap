  ...
  return (
    <ShellActionsContext.Provider value={shellActions}>
      ...
      >
                    ...
                    >
                      <Avatar className="h-6 w-6 overflow-hidden rounded-[8px] border border-[var(--strap-border)] bg-[var(--strap-surface-raised)] after:rounded-[8px]">
                        {showAvatarImage && avatarUrl ? (
                          ...
                          <AvatarFallback className="bg-transparent text-xs font-medium text-[var(--strap-text-primary)]">
                            {avatarInitials}
                          </AvatarFallback>
                        )}
                      </Avatar>
        ...
        <main className="h-screen min-w-0 overflow-hidden bg-[var(--strap-surface)]">
          {children}
        </main>
      </div>
...
export function useStrapShellFileActions(actions: ShellFileActions) {
...
export function useStrapShellActiveSection() {
  const context = useContext(ShellActionsContext);
...
/** @deprecated Use StrapShell. Retained for component-import compatibility. */
export const CreedShell = StrapShell;
/** @deprecated Use useStrapShellFileActions. */
export const useCreedShellFileActions = useStrapShellFileActions;
/** @deprecated Use useStrapShellActiveSection. */
export const useCreedShellActiveSection = useStrapShellActiveSection;
