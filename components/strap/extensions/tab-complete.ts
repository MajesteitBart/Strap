...
function buildGhostWidget(text: string) {
  ...
  wrapper.className = "strap-tab-ghost-wrapper";
  wrapper.contentEditable = "false";
  const ghost = document.createElement("span");
  ghost.className = "strap-tab-ghost";
...
function buildLoadingWidget() {
  ...
  spinner.className = "strap-tab-spinner";
      ...
      new Plugin<TabGhostState>({
        ...
        props: {
          ...
          handleKeyDown(view, event) {
            ...
            // Idle: Tab completes even inside lists (Strap bodies are mostly
