...
const FIELD_LABEL =
  "mb-2 block text-[14px] font-medium leading-5 text-[var(--strap-text-secondary)]";
const CARD =
...
function Section({
  ...
  return (
    <section className="scroll-mt-6">
      ...
      <div className={CARD}>
        {description ? (
          <p className="mb-4 text-[14px] leading-7 text-[var(--strap-text-secondary)]">
            {description}
          </p>
        ) : null}
        {children}
...
export function CompanySettings() {
  ...
  // resolve the team token when the active Strap is a company the caller
  ...
  blocks.push(
    <Section key="members" title="Members & permissions">
      ...
      <div className="flex flex-col divide-y divide-[var(--strap-border)]">
        {members.map((m) => (
          <div
            key={m.userId}
            ...
            >
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <div className="truncate text-[12px] text-[var(--strap-text-tertiary)] capitalize">
      ...
      {isManager ? (
        <div className="mt-5 border-t border-[var(--strap-border)] pt-5">
          <div className="flex items-center justify-between gap-4">
            <div className="min-w-0">
              <div className="text-[14px] font-medium text-[var(--strap-text-primary)]">
                Section access
              </div>
              <p className="mt-1 hidden text-[13px] text-[var(--strap-text-secondary)] md:block">
          ...
          {permTarget ? (
            state.sections.length ? (
              ...
              <p className="mt-4 text-[13px] text-[var(--strap-text-tertiary)]">
                No sections yet.
              </p>
            )
          ) : null}
  ...
  // account, so the shared Strap can connect to shared tools.
  if (isManager) {
    blocks.push(
          ...
          <IntegrationRow
            ...
            action={
              githubConnected ? (
                ...
                <span className="text-[13px] text-[var(--strap-text-tertiary)]">
  ...
  if (isManager) {
    blocks.push(
      <Section key="version-control" title="Version control">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-x-2 gap-y-1.5 text-[13px] text-[var(--strap-text-secondary)]">
