...
} from "@/components/strap/animated-icon-action";
...
// Anchor on Strap's own /docs page for the kebab's "Docs" action. Agents with
...
function getAgentButtonClasses(connectionId: string) {
  switch (connectionId) {
    case "codex":
    case "whirl":
      return "bg-[var(--strap-accent)] text-white transition-colors hover:bg-[var(--strap-accent-hover)]";
    case "claude":
    case "claudecode":
...
export function ConnectionCard({
  ...
  const secondaryButtonClass =
    "min-w-[116px] justify-center rounded-md border border-[var(--strap-border-strong)] bg-[var(--strap-surface)] px-4 text-[var(--strap-text-primary)] hover:bg-[var(--strap-surface-raised)]";
  ...
  return (
    <div className="flex h-auto flex-col self-start rounded-lg border border-[var(--strap-border)] bg-[var(--strap-surface)] p-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="icon-sm"
                className="shrink-0 text-[var(--strap-text-secondary)] transition-colors duration-150 hover:text-[var(--strap-text-primary)] data-[state=open]:text-[var(--strap-text-primary)]"
              >
