...
// Keyed by Strap so switching between a personal and a company Strap never
// serves the previous Strap's cached dashboard. The server scopes the response
// to the active Strap via its cookie; the key here just keeps the client cache
// buckets separate. Empty creedKey = the active/personal Strap.
