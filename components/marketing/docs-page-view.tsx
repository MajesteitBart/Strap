...
const loopSteps: LoopStep[] = [
  ...
  },
  {
    ...
    body: "Every connected agent reads your Strap before it answers, so it starts knowing your role, goals, and preferences instead of guessing.",
  },
  {
    step: "3",
